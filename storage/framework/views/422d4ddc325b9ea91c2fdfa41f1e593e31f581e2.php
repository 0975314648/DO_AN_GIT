        ...
        <div class="navbar-collapse collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="#"> <i class="fas fa-info-circle fa-fw fa-lg"></i> Giới thiệu</a></li>
                                                                    <li class="nav-item">
                    <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false" href="giangvien.html"> <i class="fas fa-book fa-fw fa-lg"></i> Giảng viên <i class="fas fa-angle-down"></i></a>
                    <ul class="dropdown-menu">                       
                        <li><a href="giangvien-lichday.html"> <i class="fas fa-fw fa-calendar"></i> Lịch dạy </a></li>
                        <li><a href="giangvien-diemdanh.html"> <i class="fas fa-fw fa-list-alt"></i> Dữ liệu điểm danh </a></li>
                    </ul>
                </li>
                                            </ul><!--//nav-->
...
</nav><!--//main-nav--><?php /**PATH C:\xampp\htdocs\DO_AN_GIT\resources\views/layout_giangvien/menu.blade.php ENDPATH**/ ?>